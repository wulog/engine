...
import "github.com/wulog/engine/pipeline"
...
type SandBoxFactory = func(config *SandboxConfig) (Sandbox, error)

var sbfMap = make(map[string]SandBoxFactory)
...
func RegisterSandBox(scriptType string, sbf SandBoxFactory) {
	// pipeline.RegisterPlugin("Sandbox", NewSandboxConfig)
	sbfMap[scriptType] = sbf
}
